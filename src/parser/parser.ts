...
export type line_5 = {kind: ASTKinds.$EOF};
        ...
        return this.run<line_1>($$dpth,
            () => {
                ...
                if (true
                    ...
                    $$res = {kind: ASTKinds.line_1, currentLine: $scope$currentLine, comment: $scope$comment, nextLine: $scope$nextLine};
                }
                return $$res;
            });
    }
        ...
        return this.run<line_2>($$dpth,
            () => {
                ...
                if (true
                    ...
                    $$res = {kind: ASTKinds.line_2, currentLine: $scope$currentLine, comment: $scope$comment, nextLine: $scope$nextLine};
                }
                return $$res;
            });
    }
        ...
        return this.run<line_3>($$dpth,
            () => {
                ...
                if (true
                    ...
                    $$res = {kind: ASTKinds.line_3, currentLine: $scope$currentLine, comment: $scope$comment, nextLine: $scope$nextLine};
                }
                return $$res;
            });
    }
        ...
        return this.run<line_4>($$dpth,
            () => {
                ...
                if (true
                    ...
                    $$res = {kind: ASTKinds.line_4, currentLine: $scope$currentLine, nextLine: $scope$nextLine};
                }
                return $$res;
            });
    }
        ...
        return this.run<comment>($$dpth,
            () => {
                ...
                if (true
                    ...
                    $$res = {kind: ASTKinds.comment, comment: $scope$comment};
                }
                return $$res;
            });
    }
